...
This approach can be very useful for efficienty enforcing constraints, an example of solving a PDE-based inverse problem using this can be found in [Chapter 13: PDE-based BIP](..//chapter01_o//chapter_o.md).
...
An example of the use of both linear randomize-then-optimize and its regularized variant can be found in [Chapter 11](..//chapter01_m/chapter01_m.md).
...
An example of the use of MYULA in CUQIpy can be found in [Chapter 11](..//chapter01_m/chapter01_m.md).
